...
3. Isolate Arctic Charr captured from a single year where age was estimated for a large number of fish.  [*Hint: Make a frequency table of `age` by `year`.*]  Use these data to answer the questions below.
```{r}
